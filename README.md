...
By [<b>Preetha Murugan</b>](https://github.com/PreethaMurugan21105)
...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/PreethaMurugan21105/-Respire-Chest-Disease-Detection?tab=readme-ov-file.git
     ```
...
2. **Run the Docker Container**
   - Start the Docker container by running the following command. Adjust the port mapping as needed:
     ```
     docker run -p 5000:5000 PreethaMurugan21105/Chest-detection-app
     ```
...
Preetha Murugan - [preetha21105@gmail.com](preetha21105@gmail.com)<br>
